...
serve() {
	...
	unset LITESTREAM_ACCESS_KEY_ID LITESTREAM_SECRET_ACCESS_KEY \
		AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY RAISECONTEXT_SUPERUSER_PASSWORD
...
if [ -n "${RAISECONTEXT_GOOGLE_CLIENT_ID:-}" ] && [ -z "${RAISECONTEXT_GOOGLE_CLIENT_SECRET:-}" ]; then
	die "RAISECONTEXT_GOOGLE_CLIENT_ID requires RAISECONTEXT_GOOGLE_CLIENT_SECRET"
elif [ -n "${RAISECONTEXT_GOOGLE_CLIENT_SECRET:-}" ] && [ -z "${RAISECONTEXT_GOOGLE_CLIENT_ID:-}" ]; then
	die "RAISECONTEXT_GOOGLE_CLIENT_SECRET requires RAISECONTEXT_GOOGLE_CLIENT_ID"
fi
...
elif [ -n "${RAISECONTEXT_SUPERUSER_EMAIL:-}" ]; then
	die "RAISECONTEXT_SUPERUSER_EMAIL is set but RAISECONTEXT_SUPERUSER_PASSWORD is missing"
elif [ -n "${RAISECONTEXT_SUPERUSER_PASSWORD:-}" ]; then
	die "RAISECONTEXT_SUPERUSER_PASSWORD is set but RAISECONTEXT_SUPERUSER_EMAIL is missing"
fi
