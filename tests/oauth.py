...
spec = importlib.util.spec_from_file_location('tc', Path(__file__).resolve().parents[1] / 'skills/raisecontext/scripts/rc.py')
...
class OAuthTest(unittest.TestCase):
    ...
    def test_oauth_configuration_needs_no_password(self):
        with patch.dict(os.environ, {'RAISECONTEXT_URL': self.cfg['url'], 'RAISECONTEXT_USER_EMAIL': self.cfg['email']}):
            os.environ.pop('RAISECONTEXT_USER_PASSWORD', None)
